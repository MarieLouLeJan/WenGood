...
function RapportsList() {
  ...
  const handleInput = (e) => {
    ...
    const allRapports = [ ...rapports ];
    const rapportsFiltered = allRapports.filter(r => r.title.toLowerCase().includes(e.target.value.toLowerCase()))
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col py-8 md:py-20 ">
          ...
          <div className='flex justify-center mb-12'>
            <input type="text" className="form-input text-blue-100 border-2 border-blue-100 rounded-full text-center px-12 text-xl" placeholder="Chercher un rapport" value={value} onChange={(e) => setValue(e.target.value)}/>
          </div>
