        ...
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <p className="text-lg text-gray-100 text-center"> Notre équipe d'experts fournit mensuellement des rapports impartiaux de haute qualité pour aider les investisseurs à prendre des décisions éclairées.</p>
            </div>
            ...
            <img className="w-16 h-16 mb-4" viewBox="0 0 64 64" src={apprentissage}/>
              ...
              <p className="text-lg text-gray-100 text-center">Nous mettons un point d'honneur à vous donner les outils permettants d'effectuer par vous même une recherche et analyse qualitative des projets web3 émergeants.</p>
            </div>
