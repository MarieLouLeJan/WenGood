    ...
    <section className='mb-8'>
      ...
      <div className="container mx-auto w-full h-full">
        ...
        <div className="wrap overflow-hidden h-full">
          ...
          <div className="hidden md:flex border-2-2 absolute border-opacity-100 border-blue-100 md:h-5/6 lg:h-4/6 border mt-12" style={{left: '50%'}} data-aos="fade-up" data-aos-delay="600"></div>
