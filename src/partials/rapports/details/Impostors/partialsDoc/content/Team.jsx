  ...
  return (
    <div className='max-w-8xl md:max-w-6xl mx-4 md:mx-12 mt-8 md:mt-0'>
      ...
      <div className="space-y-6">
        ...
        <div className="text-lg md:text-xl mx-auto" data-aos="fade-up" data-aos-delay="200">
        ...
        { team.map((t, i) => {
          ...
          return (
          <div key={i} className={`pb-8 mx-auto w-full md:w-1/2 py-4 cursor-pointer ${showDescr[i]  && 'md:my-auto'} text-center `} onClick={() => toggleDesciption(i)} >
            ...
            <div className={`flex flex-col my-auto ${ !showDescr[i] && 'md:hidden'} space-y-2`} >
              <div className='text-base  mb-1 px-8 pt-4'   data-aos="fade-up" data-aos-delay="200">
                {description}
              </div>
